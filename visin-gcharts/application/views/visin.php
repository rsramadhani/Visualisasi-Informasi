...
<script type="text/javascript">
    ...
    var pendapatan=[];
    pendapatan['dataStr'] = '<?php echo $pendapatan;?>';        
    pendapatan['dataArray'] = JSON.parse(pendapatan['dataStr']);
    ...
    drawChart(produk['dataArray'],'column','produk');
    drawChart(bulanan['dataArray'],'line','bulanan');
    drawChart(pendapatan['dataArray'],'area','pendapatan');
...
<div class="uk-container">
    <div class="uk-child-width-1-2@s" uk-grid uk-height-match="target: > div > .uk-card">    
        ...
        <div>
            <div class="uk-card uk-card-default uk-card-small uk-card-body" >
                <h3 class="uk-card-title">Penjualan Oleh Sales</h3>
        ...
        <div>
            <div class="uk-card uk-card-default uk-card-small uk-card-body" >
                <h3 class="uk-card-title">Produk Terjual</h3>
        ...
        <div>
            <div class="uk-card uk-card-default uk-card-small uk-card-body" >
                <h3 class="uk-card-title">Pendapatan Rata-Rata Bulanan</h3>
                <div id="pendapatan" style="height:350px;"></div>
            </div>
        </div>

        <div>
            <div class="uk-card uk-card-default uk-card-small uk-card-body" >
                <h3 class="uk-card-title">Penjualan Dari Produk</h3>
...
<div class="uk-flex" style="background-color:#DCDCDC; margin-top:50px; height:100px">
